export default {
  bio: {
    about: {
      text: [
        ...
        "Beyond my technical pursuits, I have a keen interest in exploration, coding, and music. Traveling, coding, and enjoying music are integral parts of my life, contributing to a well-rounded and dynamic approach to both personal and professional endeavors.",
      ],
    },
    contact: {
      text: [
  ...
  skills: [
    ...
    {
      title: "Languages",
      skillName: "Python, OpenCV, NumPy, Tkinter",
      color: "2",
      percentage: "75",
    },
    {
    ...
    {
      title: "Database",
      skillName: "Ms-SQL Server, MySql",
      color: "3",
      percentage: "85",
    },
    {
      title: "Design",
      skillName: "HTML, Bootstrap, SCSS, PHP",
      color: "5",
      percentage: "40",
    },
    {
    ...
    {
      title: "Tools",
      skillName: "Postman, PAGE,  XAMPP",
      color: "2",
      percentage: "75",
    },
    {
      title: "Tools",
      skillName: "Infragistics, SAP Crystal Reports, MS-Office",
      color: "1",
      percentage: "75",
    },
    {
      title: "Editor",
      skillName: "Visual Studio, Android Studio, VS Code",
      color: "3",
      percentage: "80",
    },
    {
    ...
    web: [
      {
        ...
        preview: "https://github.com/pratikboghani/ERP-Student",
  ...
  experience: [
    {
      ...
      details: [
        ...
        "Crafted and Integrated new reports using SQL-Server. Coded software updates to add new features, close security holes, and resolve defects.",
  ...
  education: [
    {
      title: "Web Development Post Graduate Certificate",
      duration: "2023-2024",
      subtitle: "Conestoga College, Waterloo, Canada",
      details: ["GPA : 3.73/4"],
      tags: [
    ...
    },
    {
      ...
      details: [
        "Qualified JEE Main",
        "Secured 82% in Class 12th Boards Examinations.",
      ],
  ...
  footer: [
    {
      ...
      data: [
        ...
        {
          text: "GitHub",
          link: "https://github.com/pratikboghani",
        },
        // {
        // 	text: "LeetCode",
    ...
    },
    {
      ...
      data: [
        {
          text: "Linkedin",
          link: "https://www.linkedin.com/in/pratik-boghani-2b73321b1",
        },
        {
          text: "Instagram",
          link: "https://www.instagram.com/mr.pratikboghani/",
        },
        {
          text: "Buy me a coffee",
          link: "https://www.buymeacoffee.com/pratikboghani",
        },
      ],
    },
    {
      ...
      data: [
        "Made with &hearts; by Pratik Boghani.",
